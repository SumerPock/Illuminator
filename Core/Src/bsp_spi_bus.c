...
*		V1.3	2020-03-14 Eric2013 适配STM32F4。
*
...
{	
	g_spi_busy = 0;
	//SPI_BAUDRATEPRESCALER_2  SPI_POLARITY_HIGH
	//bsp_InitSPIParam(SPI_BAUDRATEPRESCALER_16, SPI_PHASE_2EDGE, SPI_POLARITY_LOW);
	bsp_InitSPIParam(SPI_BAUDRATEPRESCALER_2 , SPI_PHASE_1EDGE , SPI_POLARITY_HIGH);
}
